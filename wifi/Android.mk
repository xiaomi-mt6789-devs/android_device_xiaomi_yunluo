...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.yunluo.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.yunluo.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.yunluo
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.yunluo.rc \
    android.hardware.wifi@1.0-service.yunluo.xml
